"""
Django settings for summergeeks project.
...
SECRET_KEY = '(73jsvg_j_zp#@%5h41jhv1ajk)meym3o_27d(#7(jtstw@d1b'
...
WSGI_APPLICATION = 'summergeeks.wsgi.application'
